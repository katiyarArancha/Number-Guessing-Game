...
def sub():
   return "The difference between target and guess is " + str(target-guess)
...
#Create the user interface, specify the dimensions of window for Python Number Guessing project
window  = Tk()
...
random_number_button = Button(window, text="Generate Random Number", command=generate_target)
